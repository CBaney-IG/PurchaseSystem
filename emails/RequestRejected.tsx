...
export default function RequestRejected({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Rejected: {requestRef} — {requestTitle}
      </Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Section style={statusBanner}>
              <Text style={statusText}>✕ Rejected</Text>
            </Section>

            <Heading style={h1}>Your request was not approved</Heading>
            <Text style={subtext}>Hi {requesterName},</Text>
            <Text style={subtext}>
              Your {requestType.toLowerCase()} has been reviewed and rejected. The reason is
              provided below.
            </Text>
            ...
            <Text style={subtext}>
              You may submit a revised request if the issue has been resolved. Contact your
              approver or procurement team for guidance.
            </Text>
