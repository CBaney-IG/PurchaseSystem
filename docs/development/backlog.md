...
| F-012 | Budget engine — real-time balance on PR form, committed-spend updates on each approval event, over-budget flagging | P0 | ✅ | F-008 | 2d | feature/F-012 | 2026-06-11 |
| F-013 | Dashboard — metric cards, approval inbox widget, recent requests list, budget alert banner, notification bell | P0 | ✅ | F-009, F-012 | 2d | feature/F-013 | 2026-06-11 |
