...
|-------------|---------------|-----|------------------|
| **Production** | `main` (auto-deploy) | [your-app].vercel.app | Production project |
| **Preview** | Any PR or branch push | Auto-generated by Vercel | Preview project |
| **Local dev** | Your machine | localhost:3000 | Points to Preview project |
